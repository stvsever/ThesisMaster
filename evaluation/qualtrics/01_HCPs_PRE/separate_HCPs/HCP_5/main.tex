...
\newtcolorbox{voorbeeldbox}[2][]{
  colback=AccentOrange,colframe=GoldAmber,
  boxrule=0.8pt,arc=2.5mm,breakable,
  left=10pt,right=10pt,top=9pt,bottom=9pt,
  fonttitle=\small\bfseries\color{GoldAmber},
  title={Uitgewerkt voorbeeld -- #2 -- Nadia (38-jarige verpleegkundige)},#1
}
...
% ── VOORBEELD DEEL 1 ─────────────────────────────────────────────────────────
\begin{voorbeeldbox}{Deel 1: Operationalisering}
\small
...
% ── VOORBEELD DEEL 2 ─────────────────────────────────────────────────────────
\begin{voorbeeldbox}{Deel 2: Initieel observatiemodel}
\small
...
sterkste vermindering van de symptomen oplevert. U selecteert op basis van drie criteria:
\begin{enumerate}[topsep=2pt,itemsep=1pt,label=\alph*)]
\item \textbf{Bewijs uit monitoring:} is er in de monitoringdata aanleiding dat deze
behandelingsoptie actief bijdraagt aan de klacht (bijv.\ hoge frequentie van problematisch
gedrag, of bijna afwezigheid van gewenst gedrag)?
\item \textbf{Klinische modificeerbaarheid:} is de behandelingsoptie realistisch veranderbaar
voor deze persoon, gegeven profiel en context?
\item \textbf{Netwerkimpact:} beinvloedt de behandelingsoptie meerdere symptomen tegelijk
(hogere return-on-intervention)?
\end{enumerate}
...
% ── VOORBEELD DEEL 3 ─────────────────────────────────────────────────────────
\begin{voorbeeldbox}{Deel 3: Behandeldoelprioritering}
\small
...
(bijv.\ ``emotieregulatietechnieken'' of ``mentale werkontkoppeling'').
...
\begin{itemize}[topsep=2pt,itemsep=1pt]
\item Een abstract behandeldoel beschrijft een \emph{gedragsdomein} (bijv.\ emotieregulatie, impulsuitstel, werkontkoppeling).
\item Een sub-behandelingsoptie is een \emph{specifiek, dagelijks meetbaar gedragsitem} dat dat domein het directst operationaliseert (bijv.\ ``emotieregulatietechniek ingezet (ja/nee)'' als sub-optie van ``emotieregulatietechnieken'').
...
% ── VOORBEELD DEEL 4 ─────────────────────────────────────────────────────────
\begin{voorbeeldbox}{Deel 4: Verfijnd observatiemodel}
\small
\textbf{Gestandaardiseerde behandeldoelen (abstract, voorbeeld):}
\begin{enumerate}[topsep=2pt,itemsep=1pt,label=\arabic*.]
\item Slaap en avondontspanning
...
Stel: doel 1 = \textit{Slaap en avondontspanning}. U ziet de volgende opties in de lijst:
\begin{itemize}[topsep=2pt,itemsep=1pt]
...
\item $\times$\ ``Cafeine-inname na 15.00 uur (aantal)'' $\rightarrow$ \textbf{niet juist} (raakt slaap zijdelings, geen directe operationalisering van avondontspanning)
\item $\times$\ ``Maaltijd op vaste tijden genuttigd (ja/nee)'' $\rightarrow$ \textbf{niet juist} (eetgedrag, niet het slaap-/ontspanningsdomein)
\end{itemize}
...
\begin{enumerate}[topsep=2pt,itemsep=1pt,label=\arabic*.]
\item \textbf{Emotieregulatietechnieken}\quad\textit{\small (domein: bewust inzetten van emotieregulatievaardigheden bij oplopende spanning; laag gebruik ondanks groot stembereik (gem.\ 1,2/dag))}
\item \textbf{Impulsuitstel en zelfbeheersing}\quad\textit{\small (domein: bewust uitstellen of afbreken van impulsieve acties voor reactie; impulsieve handelingen frequent (gem.\ 2,1/dag))}
\item \textbf{Cognitieve herwaardering bij interpersoonlijke spanning}\quad\textit{\small (domein: bewust herwaarderen van afwijzingssignalen via een alternatieve interpretatie; herwaardering zeldzaam (0,7/dag))}
\end{enumerate}
\end{contextbox}
...
\small\textbf{Gestandaardiseerde behandeldoelen (abstract) voor Deel 4:}
\begin{enumerate}[topsep=2pt,itemsep=1pt,label=\arabic*.]
\item \textbf{Mentale werkontkoppeling}\quad\textit{\small (domein: structureel loskoppelen van werkgerelateerde gedachten voor slapengaan; momenteel vrijwel afwezig; werkgedachten gem.\ 3,4 uur na 20u)}
\item \textbf{Alcoholgebruik verminderen}\quad\textit{\small (domein: bewust beperken van avondlijk alcoholgebruik als copingmechanisme; gem.\ 3,1 eenheden/avond; onderhoudt slaapfragmentatie)}
\item \textbf{Actieve stressregulatie}\quad\textit{\small (domein: bewust inzetten van stressreductietechnieken overdag ter voorkoming van nachtelijke arousal; laag maar trainbaar (gem.\ 0,9/dag))}
\end{enumerate}
\end{contextbox}
...
% ── VOORBEELD DEEL 5 ─────────────────────────────────────────────────────────
\begin{voorbeeldbox}{Deel 5: Mobiele coachingsboodschap}
\small
