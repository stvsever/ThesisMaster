...
\checkitemBFS{2}{Emotieregulatietechniek bewust ingezet (ja/nee)}
\checkitemBFS{3}{Slaapduur afgelopen nacht (uren)}
\checkitemBFS{4}{Aantal keer emotieregulatie bewust ingezet vandaag (aantal)}
\checkitemBFS{5}{Tijd op sociale media (min)}
\checkitemBFS{6}{Eetlust bij avondmaal (0--10)}
\checkitemBFS{7}{Impulsieve actie bewust uitgesteld (ja/nee)}
\checkitemBFS{8}{Ochtendenergie bij ontwaken (0--10)}
\checkitemBFS{9}{Alcoholinname vandaag (aantal)}
\checkitemBFS{10}{Wachttijd voor een impulsieve beslissing (min)}
\checkitemBFS{11}{Lichamelijke activiteit vandaag (min)}
\checkitemBFS{12}{Stemmingsbereik vandaag (0--10)}
\checkitemBFS{13}{Ervaren afwijzing cognitief herwaardeert (ja/nee)}
\checkitemBFS{14}{Aantal onafgewerkte taken (aantal)}
\checkitemBFS{15}{Concentratie tijdens administratie (0--10)}
\checkitemBFS{16}{Alternatieve verklaring voor afwijzing gegeven (ja/nee)}
\checkitemBFS{17}{Middagdutje genomen (ja/nee)}
\checkitemBFS{18}{Sociale media gebruik na werk (min)}
\checkitemBFS{19}{Aantal conflicten op het werk (aantal)}
...
\checkitemBFS{2}{Werkapparaten uitgeschakeld voor slapengaan (ja/nee)}
\checkitemBFS{3}{Ochtendvermoeidheid bij ontwaken (0--10)}
\checkitemBFS{4}{Werkontkoppelingsritueel gevolgd na 21.00 uur (min)}
\checkitemBFS{5}{Aantal vergaderuren vandaag (uren)}
\checkitemBFS{6}{Hoofdpijnintensiteit namiddag (0--10)}
\checkitemBFS{7}{Alcoholeenheden geconsumeerd na 19.00 uur (aantal)}
\checkitemBFS{8}{Lichamelijke spierspanning in de ochtend (0--10)}
\checkitemBFS{9}{Cafeine-inname na 16.00 uur (aantal)}
\checkitemBFS{10}{Avond zonder alcoholinname (ja/nee)}
\checkitemBFS{11}{Aerobe beweging vandaag (min)}
\checkitemBFS{12}{Eetlust bij avondmaal (0--10)}
\checkitemBFS{13}{Stressregulatietechniek ingezet overdag (ja/nee)}
\checkitemBFS{14}{Contact met gezin vandaag (ja/nee)}
\checkitemBFS{15}{Middagdutje genomen (ja/nee)}
\checkitemBFS{16}{Duur bewuste stressverlichtingsactiviteit overdag (min)}
\checkitemBFS{17}{Werkgerelateerde gedachten na 20.00 uur (min)}
\checkitemBFS{18}{Schermtijd voor ontspanning na 21.00 uur (min)}
\checkitemBFS{19}{Ochtendstemming bij ontwaken (0--10)}
