...
\hypersetup{
  ...
  linkcolor=black,
  urlcolor=black,
  pdftitle={PHOENIX evaluatiestudie - HCP-PRE-09 (C09)},
...
\fancyhead[R]{\small\color{SlateMid}\textbf{HCP-PRE-09}\quad C09}
...
\centering
{\large\bfseries\color{DarkBlue}Deelnemerscode: \texttt{HCP-PRE-09}}\\[0.5em]
...
\item \textbf{BO-3 (Ademhaling sessie)} -- beschermend effect op S-2 (rode lijn);
frequentie hoog (gem.\ 2,4/dag, goed) $\rightarrow$ \textbf{prioriteit 3} (toestand reeds goed).
\end{enumerate}
\end{voorbeeldbox}
...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=0.4pt,  draw=StrongRed!85, opacity=0.90] (bo4.east) -- (s2.west);
  \draw[line width=0.45pt, draw=StrongRed!85, opacity=0.90] (bo5.east) -- (s4.west);
  \draw[line width=0.4pt, draw=StrongRed!85, opacity=0.90] (bo5.east) -- (s1.west);
  % Legend
...
\checkitemBFS{1}{Cafeine-inname na 14.00 uur beperkt (ja/nee)}
\checkitemBFS{2}{Emotieregulatietechniek (bijv.\ grounding, ademhaling) bewust ingezet (ja/nee)}
\checkitemBFS{3}{Waterinname vandaag (glazen)}
\checkitemBFS{4}{Aantal keer een bewuste emotieregulatievaardigheid ingezet vandaag (aantal)}
\checkitemBFS{5}{Medicatie op voorgeschreven tijdstip ingenomen (ja/nee)}
\checkitemBFS{6}{Gebalanceerde maaltijden op vaste tijden genuttigd vandaag (ja/nee)}
\checkitemBFS{7}{Impulsieve actie bewust uitgesteld of niet ondernomen (ja/nee)}
\checkitemBFS{8}{Omega-3- of vitamine-D-supplement ingenomen (ja/nee)}
\checkitemBFS{9}{Alcoholconsumptie vandaag (eenheden)}
\checkitemBFS{10}{Wachttijd aangehouden voor impulsieve beslissing of actie (min)}
\checkitemBFS{11}{Sigaretten of tabak gerookt vandaag (aantal)}
\checkitemBFS{12}{Vast slaap- en waktijdstip aangehouden vandaag (ja/nee)}
\checkitemBFS{13}{Ervaren afwijzing bewust herwaardeert via een alternatieve interpretatie (ja/nee)}
\checkitemBFS{14}{Financiele zorgen of administratieve taken aangepakt vandaag (ja/nee)}
\checkitemBFS{15}{Lichaamsbeweging of sport vandaag (min)}
\checkitemBFS{16}{Alternatieve verklaring voor een afwijzingssignaal bewust geformuleerd (ja/nee)}
\checkitemBFS{17}{Lichttherapielamp of wekker op licht gebruikt in de ochtend (ja/nee)}
\checkitemBFS{18}{Professioneel consult of therapeutische sessie bijgewoond vandaag (ja/nee)}
\checkitemBFS{19}{Pijnklachten of lichamelijke ongemakken bijgehouden in een dagboek (ja/nee)}
...
\begin{center}
\texttt{stijn.vanseveren@ugent.be}\quad met onderwerp:\quad \texttt{PHOENIX-PRE-HCP-PRE-09}
\end{center}
