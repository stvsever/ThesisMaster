...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=2.05pt, draw=StrongRed!85, opacity=0.90] (p1.east) -- (cr1.west);
  \draw[line width=1.95pt, draw=StrongRed!85, opacity=0.90] (p1.east) -- (cr2.west);
  \draw[line width=1.38pt, draw=StrongRed!85, opacity=0.90] (p2.east) -- (cr2.west);
  \draw[line width=1.9pt, draw=PrimaryBlue!80, opacity=0.90] (p3.east) -- (cr2.west);
  \draw[line width=1.3pt, draw=PrimaryBlue!80, opacity=0.90] (p3.east) -- (cr1.west);
  \draw[line width=2.05pt, draw=PrimaryBlue!80, opacity=0.90] (p4.east) -- (cr3.west);
  \draw[line width=1.38pt, draw=PrimaryBlue!80, opacity=0.90] (p5.east) -- (cr1.west);
  \draw[line width=1.55pt, draw=PrimaryBlue!80, opacity=0.90] (p5.east) -- (cr4.west);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=2.12pt, draw=StrongRed!85, opacity=0.90] (p1.east) -- (cr3.west);
  \draw[line width=2.0pt, draw=StrongRed!85, opacity=0.90] (p1.east) -- (cr2.west);
  \draw[line width=1.88pt, draw=StrongRed!85, opacity=0.90] (p2.east) -- (cr2.west);
  \draw[line width=1.38pt, draw=StrongRed!85, opacity=0.90] (p2.east) -- (cr1.west);
  \draw[line width=1.95pt, draw=StrongRed!85, opacity=0.90] (p3.east) -- (cr2.west);
  \draw[line width=1.8pt, draw=StrongRed!85, opacity=0.90] (p3.east) -- (cr1.west);
  \draw[line width=2.0pt, draw=PrimaryBlue!80, opacity=0.90] (p4.east) -- (cr3.west);
  \draw[line width=1.3pt, draw=PrimaryBlue!80, opacity=0.90] (p5.east) -- (cr4.west);
\end{tikzpicture}
\end{center}
