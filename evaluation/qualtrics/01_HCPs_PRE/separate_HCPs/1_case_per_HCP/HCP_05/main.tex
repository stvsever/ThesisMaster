...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=0.45pt, draw=StrongRed!85, opacity=0.90] (p4.east) -- (cr4.west);
  \draw[line width=0.4pt, draw=StrongRed!85, opacity=0.90] (p4.east) -- (cr1.west);
...
\checkitemBFS{6}{Alcoholconsumptie gisteravond (eenheden)}
...
\checkitemBFS{18}{Vast slaap- en waktijdstip aangehouden vandaag (ja/nee)}
\checkitemBFS{19}{Cafeine-inname na 15.00 uur beperkt (ja/nee)}
