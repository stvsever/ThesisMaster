...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=4.36pt, draw=StrongRed!85, opacity=0.90] (p1.east) -- (cr1.west);
  ...
  \draw[line width=1.32pt, draw=StrongRed!85, opacity=0.90] (p3.east) -- (cr1.west);
  \draw[line width=2.92pt, draw=StrongRed!85, opacity=0.90] (p3.east) -- (cr2.west);
  \draw[line width=3.96pt, draw=StrongRed!85, opacity=0.90] (p4.east) -- (cr1.west);
  \draw[line width=1.0pt, draw=StrongRed!85, opacity=0.90] (p4.east) -- (cr4.west);
  \draw[line width=4.52pt, draw=StrongRed!85, opacity=0.90] (p5.east) -- (cr4.west);
...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=5.0pt, draw=StrongRed!85, opacity=0.90] (p1.east) -- (cr2.west);
  \draw[line width=3.96pt, draw=StrongRed!85, opacity=0.90] (p1.east) -- (cr1.west);
  \draw[line width=1.32pt, draw=StrongRed!85, opacity=0.90] (p2.east) -- (cr1.west);
  \draw[line width=4.76pt, draw=StrongRed!85, opacity=0.90] (p3.east) -- (cr3.west);
  \draw[line width=4.52pt, draw=StrongRed!85, opacity=0.90] (p4.east) -- (cr4.west);
  \draw[line width=1.0pt, draw=StrongRed!85, opacity=0.90] (p4.east) -- (cr2.west);
  \draw[line width=3.16pt, draw=StrongRed!85, opacity=0.90] (p5.east) -- (cr2.west);
  % Legend (3 stacked rows)
  \draw[line width=0.3pt, draw=black!25] (-0.3, -2.82) -- (9.3, -2.82);
  \draw[line width=2.2pt, draw=PrimaryBlue!80, opacity=0.90] (0.1, -3.18) -- (1.2, -3.18);
  \node[font=\fontsize{5.5}{7}\selectfont, anchor=west, text=black!70] at (1.35, -3.18) {\textbf{Blauw} = positief verband \enspace (predictor \emph{vergroot} criterium)};
