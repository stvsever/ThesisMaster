...
\begin{complaintbox}[title={Casus 2: 32-jarige marketingprofessional; duur: 2 jaar}]
...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=2.5pt, draw=PrimaryBlue!80, opacity=0.90] (p4.east) -- (cr1.west);
  \draw[line width=3.8pt, draw=StrongRed!85, opacity=0.90] (p5.east) -- (cr4.west);
  \draw[line width=1.5pt, draw=StrongRed!85, opacity=0.90] (p5.east) -- (cr1.west);
  \draw[line width=0.3pt, draw=black!25] (-0.3,-2.82) -- (9.3,-2.82);
  \draw[line width=2.2pt, draw=PrimaryBlue!80, opacity=0.90] (0.1,-3.18) -- (1.2,-3.18);
  \node[font=\fontsize{5.5}{7}\selectfont, anchor=west, text=black!70] at (1.35,-3.18) {\textbf{Blauw} = positief verband \enspace (BO \emph{vergroot} S)};
  \draw[line width=2.2pt, draw=StrongRed!85, opacity=0.90] (0.1,-3.62) -- (1.2,-3.62);
...
\begin{enumerate}[topsep=2pt,itemsep=1pt,label=\arabic*.]
\item \textbf{Compulsie-uitstel}
\item \textbf{Situatiebetreding}
\item \textbf{Onzekerheids- en intrusietolerantie}
\end{enumerate}
\end{contextbox}
...
\checkitemBFS{1}{Slaaptijd gisteravond (uren)}
\checkitemBFS{2}{Presentatie, vergadering of zichtbaar werkmoment bewust opgezocht of deelgenomen (ja/nee)}
\checkitemBFS{3}{Lichaamsbeweging vandaag (min)}
\checkitemBFS{4}{Alcoholinname vanavond (eenheden)}
\checkitemBFS{5}{Exposurestap in werksituatie volledig doorlopen zonder vroegtijdig terugtrekken (ja/nee)}
\checkitemBFS{6}{Maaltijd op vaste tijden genuttigd (ja/nee)}
\checkitemBFS{7}{Post-event ruminatie bewust afgesloten via schrijfoefening of afsluitritueel (ja/nee)}
\checkitemBFS{8}{Waterinname vandaag (glazen)}
\checkitemBFS{9}{Stappentelling overdag (stappen)}
\checkitemBFS{10}{Tijdsduur piekeren over werkprestatie bewust beperkt of omgeleid (min)}
\checkitemBFS{11}{Sociaal contact op eigen initiatief buiten werk gezocht (ja/nee)}
\checkitemBFS{12}{Schermtijd voor slapengaan (min)}
\checkitemBFS{13}{Vermijdingsepisode in werksituatie geregistreerd in dagboek (ja/nee)}
\checkitemBFS{14}{Cafeine-inname vandaag (aantal dranken)}
\checkitemBFS{15}{Bewuste ontspanningsoefening of ademhaling uitgevoerd (min)}
\checkitemBFS{16}{Aantal situaties waarbij zichtbaarheid of beoordeling bewust vermeden werd vandaag (aantal)}
\checkitemBFS{17}{Werkuren vandaag (uren)}
\checkitemBFS{18}{Geruststellingsvraag aan collega of leidinggevende gesteld (aantal)}
\checkitemBFS{19}{Voorbereidingstijd voor vergadering of presentatie vandaag (min)}
\checkitemBFS{20}{Middagpauze bewust weggestapt van werkplek (ja/nee)}
\vspace{0.4em}
\noindent\textbf{Totaal geselecteerd:}\hspace{0.5em}\rule{1.2cm}{0.25pt}\hspace{0.2em}/ 6
\end{responsebox}
