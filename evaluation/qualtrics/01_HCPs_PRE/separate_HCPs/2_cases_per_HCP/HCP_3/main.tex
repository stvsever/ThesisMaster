...
\begin{enumerate}[topsep=2pt,itemsep=1pt,label=\arabic*.]
\item \textbf{Compulsie- en ritueeluitstel}
\item \textbf{Gedragsexperiment en situatiebetreding}
...
\small\textbf{Gestandaardiseerde behandeldoelen (abstract) voor Deel 4:}
\begin{enumerate}[topsep=2pt,itemsep=1pt,label=\arabic*.]
\item \textbf{Professionele exposure en gedragsexperiment}
\item \textbf{Cognitieve naverwerking en ruminatiebeheer}
\item \textbf{Vermijdingsmonitoring en bewustwording}
\end{enumerate}
\end{contextbox}
