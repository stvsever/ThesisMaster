...
\newtcolorbox{voorbeeldbox}[3][]{
  ...
  fonttitle=\small\bfseries\color{GoldAmber},
  halign title=center,
  title={Uitgewerkt voorbeeld -- #2 -- Nadia (38-jarige verpleegkundige)\\[3pt]%
    {\footnotesize\itshape\color{DarkBlue}#3}},#1
}
...
\item \textbf{S-2}\enspace Vroeg ontwaken
  \hfill\textit{(``word vroeg wakker'' $\rightarrow$ onderscheidbaar van S-1)}
...
S-1: Inslaapmoeilijkheden;\enspace S-2: Vroeg ontwaken;\enspace S-3: Vermoeidheid overdag;\enspace S-4: Prikkelbaarheid;\enspace S-5: Sociale terugtrekking.
