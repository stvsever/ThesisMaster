...
* Raincloud plot (Allen et al. 2019) is the primary within-subjects comparison figure;
  it exposes raw data, density, and summary statistics in one compact panel.
...
def tost_test(
    ...
    ----------
    delta : float
        Equivalence margin (in rating-scale units; default 0.5 on a 1–9 scale,
        approximately half a minimal clinically important difference).
    """
