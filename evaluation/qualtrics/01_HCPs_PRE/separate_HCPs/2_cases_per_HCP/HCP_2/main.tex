...
\begin{enumerate}[topsep=2pt,itemsep=1pt,label=\arabic*.]
\item \textbf{Werkgrenzen en mentale ontkoppeling}
\item \textbf{Herstel en ontspanning buiten werk}
...
\small\textbf{Gestandaardiseerde behandeldoelen (abstract) voor Deel 4:}
\begin{enumerate}[topsep=2pt,itemsep=1pt,label=\arabic*.]
\item \textbf{Betekenis en waardegerichte activiteit}
\item \textbf{Slaapregulariteit}
\item \textbf{Zelfcompassie en cognitieve herwaardering}
\end{enumerate}
\end{contextbox}
