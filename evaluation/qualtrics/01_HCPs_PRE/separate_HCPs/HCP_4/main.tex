...
\checkitemBFS{2}{Geplande activiteit uit agenda uitgevoerd (ja/nee)}
\checkitemBFS{3}{Eetlust in de ochtend (0--10)}
\checkitemBFS{4}{Voltooiingsgraad van dagschema vandaag (0--10)}
\checkitemBFS{5}{Werkgerelateerd piekeren in de avond (min)}
\checkitemBFS{6}{Pijnklachten in de rug (0--10)}
\checkitemBFS{7}{Opstaan op geplande wektijd (ja/nee)}
\checkitemBFS{8}{Tijd op sociale media (min)}
\checkitemBFS{9}{Verschil geplande versus werkelijke bedtijd (min)}
\checkitemBFS{10}{Alcoholinname vanavond (aantal)}
\checkitemBFS{11}{Middagdutje genomen (ja/nee)}
\checkitemBFS{12}{Concentratie tijdens administratie (0--10)}
\checkitemBFS{13}{Zelf contact opgenomen met een bekende (ja/nee)}
\checkitemBFS{14}{Plezierige activiteit voltooid (ja/nee)}
\checkitemBFS{15}{Hopeloosheidsgedachten uitgedaagd (ja/nee)}
\checkitemBFS{16}{Duur van sociaal contact op eigen initiatief (min)}
\checkitemBFS{17}{Waterinname vandaag (glazen)}
\checkitemBFS{18}{Werkuren vandaag (uren)}
\checkitemBFS{19}{Aantal maaltijden overgeslagen (aantal)}
...
\checkitemBFS{2}{To-dolijst of digitale planner geraadpleegd (ja/nee)}
\checkitemBFS{3}{Slaapduur afgelopen nacht (uren)}
\checkitemBFS{4}{Nieuwe taken direct in het systeem ingevoerd (ja/nee)}
\checkitemBFS{5}{Tijd op sociale media tijdens werk (min)}
\checkitemBFS{6}{Spierspanning in de namiddag (0--10)}
\checkitemBFS{7}{Actief luisteren bewust geoefend in gesprek (ja/nee)}
\checkitemBFS{8}{Aantal onderbrekingen door notificaties (aantal)}
\checkitemBFS{9}{Afleiding weggelegd tijdens een gesprek (ja/nee)}
\checkitemBFS{10}{Emotionele kwetsbaarheid na kritiek (0--10)}
\checkitemBFS{11}{Eetlust rond de lunch (0--10)}
\checkitemBFS{12}{Afgesloten taak bewust positief erkend (ja/nee)}
\checkitemBFS{13}{Alcoholinname in de avond (aantal)}
\checkitemBFS{14}{Stemmingsschommeling vandaag (0--10)}
\checkitemBFS{15}{Kleine beloning gegeven na taakvoltooiing (ja/nee)}
\checkitemBFS{16}{Stapelteller vandaag (aantal)}
\checkitemBFS{17}{Ochtendlichtblootstelling (min)}
\checkitemBFS{18}{Middagdutje genomen (ja/nee)}
\checkitemBFS{19}{Plezier in vrijetijdsbesteding (0--10)}
\checkitemBFS{20}{Aantal huishoudelijke taken gestart (aantal)}
\vspace{0.4em}
\noindent\textbf{Totaal geselecteerd:}\hspace{0.5em}\rule{1.2cm}{0.25pt}\hspace{0.2em}/ 6
\end{responsebox}
