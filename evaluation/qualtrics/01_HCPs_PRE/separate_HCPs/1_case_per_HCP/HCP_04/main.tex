...
\hypersetup{
  ...
  linkcolor=black,
  urlcolor=black,
  pdftitle={PHOENIX evaluatiestudie - HCP-PRE-04 (C04)},
...
\fancyhead[R]{\small\color{SlateMid}\textbf{HCP-PRE-04}\quad C04}
...
\subsection*{Casus 1: 63-jarige gepensioneerde professional}

\begin{complaintbox}[title={Casus 1: 63-jarige gepensioneerde professional; duur: 9 maanden na overlijden van partner}]
...
\newpage
\subsection*{Casus 1: 63-jarige gepensioneerde professional -- Deel 2}
...
\newpage
\subsection*{Casus 1: 63-jarige gepensioneerde professional -- Deel 3}

\begin{complaintbox}[title={Casus 1: 63-jarige gepensioneerde professional}]
...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=0.45pt, draw=StrongRed!85, opacity=0.90] (p5.east) -- (cr3.west);
  \draw[line width=0.4pt,  draw=StrongRed!85, opacity=0.90] (p3.east) -- (cr1.west);
...
\newpage
\subsection*{Casus 1: 63-jarige gepensioneerde professional -- Deel 4}
...
\checkitemBFS{4}{Gebalanceerde maaltijden op vaste tijden genuttigd vandaag (ja/nee)}
\checkitemBFS{5}{Omega-3- of vitamine-D-supplement ingenomen (ja/nee)}
...
\checkitemBFS{10}{Gesprek met vertrouwenspersoon of steunfiguur gevoerd vandaag (ja/nee)}
\checkitemBFS{11}{Afwijking van gewone slaap- of waktijdstip vandaag (min)}
\checkitemBFS{12}{Financiele zorgen of administratieve taken aangepakt vandaag (ja/nee)}
\checkitemBFS{13}{Lichttherapielamp of wekker op licht gebruikt in de ochtend (ja/nee)}
\checkitemBFS{14}{Zelfkritische gedachte bewust omgevormd naar mildere formulering (ja/nee)}
\checkitemBFS{15}{Professioneel consult of therapeutische sessie bijgewoond vandaag (ja/nee)}
\checkitemBFS{16}{Pijnklachten of lichamelijke ongemakken bijgehouden in een dagboek (ja/nee)}
...
\checkitemBFS{19}{Lichaamsbeweging of wandeling buiten uitgevoerd (min)}
...
\newpage
\subsection*{Casus 1: 63-jarige gepensioneerde professional -- Deel 5}
