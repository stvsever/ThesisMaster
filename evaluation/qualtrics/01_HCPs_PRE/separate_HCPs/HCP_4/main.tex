...
(bijv.\ ``gedragsactivatie'' of ``slaapregulariteit'').
...
\begin{itemize}[topsep=2pt,itemsep=1pt]
\item Een abstract behandeldoel beschrijft een \emph{gedragsdomein} (bijv.\ gedragsactivatie, slaapregulariteit, sociaal initiatief).
\item Een sub-behandelingsoptie is een \emph{specifiek, dagelijks meetbaar gedragsitem} dat dat domein het directst operationaliseert (bijv.\ ``geplande activiteit uitgevoerd (ja/nee)'' als sub-optie van ``gedragsactivatie'').
