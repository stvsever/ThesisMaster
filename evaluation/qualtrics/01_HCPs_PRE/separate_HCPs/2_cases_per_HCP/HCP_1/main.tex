...
\begin{itemize}[topsep=2pt,itemsep=1pt]
\item \textbf{S-1} Inslaapproblemen
\item \textbf{S-2} Cognitieve hyperarousal
\item \textbf{S-3} Sociale anhedonie
\item \textbf{S-4} Stressgerelateerde spierspanning
\end{itemize}
\end{contextbox}
...
\small\textbf{Gestandaardiseerde symptomen uit Deel 1:}
\begin{itemize}[topsep=2pt,itemsep=1pt]
\item \textbf{S-1} Recidiverende paniekepisoden
\item \textbf{S-2} Anticipatieangst
\item \textbf{S-3} Situationele vermijding
\item \textbf{S-4} Beroepsmatige interferentie
\end{itemize}
\end{contextbox}
...
(meer van BO $\rightarrow$ meer van S; bijv.\ meer veiligheidsgedrag $\rightarrow$ meer angst).
\item \textbf{Rode rand:} behandelingsoptie heeft een negatief verband met het symptoom
(meer van BO $\rightarrow$ minder van S; bijv.\ meer exposure $\rightarrow$ minder vermijding).
...
\begin{tikzpicture}[node distance=0pt]
  ...
  \node[smcrnode] (s1) at (7.5, 0.9) {S-1\\Inslaap- \& doorslaapmoeijlijkheden};
...
\begin{center}
\begin{tikzpicture}[node distance=0pt]
  \node[prnode] (p1) at (0, 2.2) {BO-1\\Late avondschermtijd};
  \node[prnode] (p2) at (0, 1.1) {BO-2\\Dagelijkse taakaccumulatie};
  \node[prnode] (p3) at (0, 0.0) {BO-3\\Preslaap cognitieve offloading};
  \node[prnode] (p4) at (0,-1.1) {BO-4\\Sociale participatie};
  \node[prnode] (p5) at (0,-2.2) {BO-5\\Aerobe beweging};
  \node[crnode] (cr1) at (9, 1.65) {S-1\\Inslaapproblemen};
  \node[crnode] (cr2) at (9, 0.55) {S-2\\Cognitieve hyperarousal};
  \node[crnode] (cr3) at (9,-0.55) {S-3\\Sociale anhedonie};
  \node[crnode] (cr4) at (9,-1.65) {S-4\\Stressgerelateerde spierspanning};
...
\textbf{BO-1: Late avondschermtijd},\quad
\textbf{BO-2: Dagelijkse taakaccumulatie},\quad
\textbf{BO-3: Preslaap cognitieve offloading},\quad
\textbf{BO-4: Sociale participatie},\quad
\textbf{BO-5: Aerobe beweging}
...
\begin{center}
\begin{tikzpicture}[node distance=0pt]
  \node[prnode] (p1) at (0, 2.2) {BO-1\\Vermijdingsgedrag};
  \node[prnode] (p2) at (0, 1.1) {BO-2\\Veiligheidsgedrag};
  \node[prnode] (p3) at (0, 0.0) {BO-3\\Interoceptieve focus};
  \node[prnode] (p4) at (0,-1.1) {BO-4\\Geplande exposure};
  \node[prnode] (p5) at (0,-2.2) {BO-5\\Dagstructuur};
  \node[crnode] (cr1) at (9, 1.65) {S-1\\Recidiverende paniekepisoden};
  \node[crnode] (cr2) at (9, 0.55) {S-2\\Anticipatieangst};
  \node[crnode] (cr3) at (9,-0.55) {S-3\\Situationele vermijding};
  \node[crnode] (cr4) at (9,-1.65) {S-4\\Beroepsmatige interferentie};
...
\noindent\textbf{Beschikbare behandelingsopties:}\enspace
\textbf{BO-1: Vermijdingsgedrag},\quad
\textbf{BO-2: Veiligheidsgedrag},\quad
\textbf{BO-3: Interoceptieve focus},\quad
\textbf{BO-4: Geplande exposure},\quad
\textbf{BO-5: Dagstructuur}
...
\begin{enumerate}[topsep=2pt,itemsep=1pt,label=\arabic*.]
\item \textbf{Slaapkwaliteit}
\item \textbf{Cognitieve ontlading}
\item \textbf{Lichamelijke activiteit}
\end{enumerate}
\end{contextbox}
...
\checkitemBFS{1}{Waterinname vandaag (glazen)}
\checkitemBFS{2}{Medicatie op voorgeschreven tijdstip ingenomen (ja/nee)}
\checkitemBFS{3}{Vast slaap- en waktijdstip aangehouden vandaag (ja/nee)}
\checkitemBFS{4}{Openstaande taken of zorgen schriftelijk genoteerd voor slapengaan (ja/nee)}
\checkitemBFS{5}{Gesprek met vertrouwenspersoon of steunfiguur gevoerd vandaag (ja/nee)}
\checkitemBFS{6}{Duur matige tot intensieve lichaamsbeweging vandaag (min)}
\checkitemBFS{7}{Alcoholconsumptie vanavond (eenheden)}
\checkitemBFS{8}{Tijdsduur bewust piekeren of takennotitie voor slapengaan (min)}
\checkitemBFS{9}{Omega-3- of vitamine-D-supplement ingenomen (ja/nee)}
\checkitemBFS{10}{Geplande beweegactiviteit uitgevoerd vandaag (ja/nee)}
\checkitemBFS{11}{Lichttherapielamp of wekker op licht gebruikt in de ochtend (ja/nee)}
\checkitemBFS{12}{Gebalanceerde maaltijden op vaste tijden genuttigd vandaag (ja/nee)}
\checkitemBFS{13}{Professioneel consult of therapeutische sessie bijgewoond vandaag (ja/nee)}
\checkitemBFS{14}{Schermvrij interval direct voor slapengaan (min)}
\checkitemBFS{15}{Sigaretten of tabak gerookt vandaag (aantal)}
\checkitemBFS{16}{Betekenisvolle of waardegerichte activiteit ondernomen vandaag (ja/nee)}
\checkitemBFS{17}{Financiele zorgen of administratieve taken aangepakt vandaag (ja/nee)}
\checkitemBFS{18}{Bewust dankbaarheidsoefening of positieve reflectie uitgevoerd vandaag (ja/nee)}
\checkitemBFS{19}{Werkpauzes op vaste tijden genomen vandaag (ja/nee)}
\checkitemBFS{20}{Pijnklachten of lichamelijke ongemakken bijgehouden in een dagboek (ja/nee)}
\vspace{0.4em}
...
\small\textbf{Gestandaardiseerde behandeldoelen (abstract) voor Deel 4:}
\begin{enumerate}[topsep=2pt,itemsep=1pt,label=\arabic*.]
\item \textbf{Exposureopbouw}
\item \textbf{Veiligheidsgedragsreductie}
\item \textbf{Interoceptieve aandachtsturing}
\end{enumerate}
\end{contextbox}
...
\checkitemBFS{1}{Exposurestap bewust en volledig uitgevoerd vandaag (ja/nee)}
\checkitemBFS{2}{Medicatie op voorgeschreven tijdstip ingenomen (ja/nee)}
\checkitemBFS{3}{Gebalanceerde maaltijden op vaste tijden genuttigd vandaag (ja/nee)}
\checkitemBFS{4}{Duur verblijf in eerder vermeden of angststimulerende situatie (min)}
\checkitemBFS{5}{Waterinname vandaag (glazen)}
\checkitemBFS{6}{Omega-3- of vitamine-D-supplement ingenomen (ja/nee)}
\checkitemBFS{7}{Veiligheidsgedraging bewust nagelaten bij angstsituatie (ja/nee)}
\checkitemBFS{8}{Werkuren vandaag (uren)}
\checkitemBFS{9}{Cafeine-inname na 15.00 uur beperkt (ja/nee)}
\checkitemBFS{10}{Aantal veiligheidsgedragingen bewust vermeden of uitgesteld (aantal)}
\checkitemBFS{11}{Lichttherapielamp of wekker op licht gebruikt in de ochtend (ja/nee)}
\checkitemBFS{12}{Gesprek met vertrouwenspersoon of steunfiguur gevoerd vandaag (ja/nee)}
\checkitemBFS{13}{Interoceptieve oefening bewust uitgevoerd vandaag (min)}
\checkitemBFS{14}{Sigaretten of tabak gerookt vandaag (aantal)}
\checkitemBFS{15}{Financiele zorgen of administratieve taken aangepakt vandaag (ja/nee)}
\checkitemBFS{16}{Professioneel consult of therapeutische sessie bijgewoond vandaag (ja/nee)}
\checkitemBFS{17}{Lichamelijke sensaties benoemd zonder vlucht- of veiligheidsreactie (ja/nee)}
\checkitemBFS{18}{Alcoholconsumptie vanavond (eenheden)}
\checkitemBFS{19}{Betekenisvolle of waardegerichte activiteit ondernomen vandaag (ja/nee)}
\checkitemBFS{20}{Bewust dankbaarheidsoefening of positieve reflectie uitgevoerd vandaag (ja/nee)}
\vspace{0.4em}
\noindent\textbf{Totaal geselecteerd:}\hspace{0.5em}\rule{1.2cm}{0.25pt}\hspace{0.2em}/ 6
\end{responsebox}
...
De boodschap erkent de barriere (gewoontekracht), geeft een concrete actie met tijdstip (21.30u), verlaagt de drempel (``gewoon even niets'') en vergroot de zelfeffectiviteit (``eén avond is genoeg'').
\end{voorbeeldbox}
...
Copingstrategie & Werk met een concrete exposurehierarchie en een vooraf afgesproken copingzin per stap. \\
\end{tabular}
\end{contextbox}
