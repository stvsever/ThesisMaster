...
(bijv.\ ``slaap en avondherstel'' of ``lichamelijke activiteit'').
...
\begin{itemize}[topsep=2pt,itemsep=1pt]
\item Een abstract behandeldoel beschrijft een \emph{gedragsdomein} (bijv.\ slaap, beweging, sociaal contact).
\item Een sub-behandelingsoptie is een \emph{specifiek, dagelijks meetbaar gedragsitem} dat dat domein het directst operationaliseert (bijv.\ ``schermvrij interval voor slapengaan (min)'' als sub-optie van ``slaap en avondherstel'').
...
\item $\times$\ ``Cafeïne-inname na 15.00 uur (aantal)'' $\rightarrow$ \textbf{niet juist} (raakt slaap zijdelings, geen directe operationalisering van avondontspanning)
...
\begin{enumerate}[topsep=2pt,itemsep=1pt,label=\arabic*.]
\item \textbf{Slaap en avondherstel}\quad\textit{\small (domein: schermgebruik en inslaaproutine; hoogste netwerkimpact op S-1 en S-2)}
\item \textbf{Cognitieve ontlading}\quad\textit{\small (domein: het mentaal loslaten van taken en zorgen voor het slapengaan; nauwelijks ingezet)}
\item \textbf{Lichamelijke activiteit}\quad\textit{\small (domein: aerobe en matige beweging; zeer lage frequentie (0,7 sessies/week))}
\end{enumerate}
\end{contextbox}
...
\checkitemBFS{1}{Schermvrij interval direct voor slapengaan (min)}
\checkitemBFS{2}{Cafeine-inname na 15.00 uur (aantal dranken)}
...
\checkitemBFS{5}{Bewust sociaal contact gezocht of beantwoord vandaag (ja/nee)}
\checkitemBFS{6}{Duur matige tot intensieve lichaamsbeweging vandaag (min)}
\checkitemBFS{7}{Ochtendlichtblootstelling buiten in de ochtend (min)}
...
\checkitemBFS{13}{Middagdutje genomen (ja/nee)}
\checkitemBFS{14}{Geplande sociale activiteit bijgewoond of geinitieerd (ja/nee)}
\checkitemBFS{15}{Bewuste ontspanningsoefening of ademhaling in avond uitgevoerd (min)}
\checkitemBFS{16}{Maaltijd op vaste tijden genuttigd (ja/nee)}
\checkitemBFS{17}{Stappentelling overdag (stappen)}
\checkitemBFS{18}{Werkgerelateerde taken afgesloten en bewust losgekoppeld na werktijd (ja/nee)}
\checkitemBFS{19}{Schermvrije werkpauze genomen tijdens werkdag (min)}
\checkitemBFS{20}{Professioneel herstelmoment (hobby, buiten, creatief) uitgevoerd in avond (min)}
\vspace{0.4em}
...
\small\textbf{Gestandaardiseerde behandeldoelen (abstract) voor Deel 4:}
\begin{enumerate}[topsep=2pt,itemsep=1pt,label=\arabic*.]
\item \textbf{Exposure en gedragsexperiment}\quad\textit{\small (domein: het bewust opzoeken van gevreesde situaties; nagenoeg afwezig (0,3/dag))}
\item \textbf{Vermindering van veiligheids- en vermijdingsgedrag}\quad\textit{\small (domein: bewust nalaten van angstverminderende maar angstonderhoudende acties; hoge frequentie (8,7/dag))}
\item \textbf{Interoceptieve aandachtsturing}\quad\textit{\small (domein: bewuste omgang met lichamelijke sensaties zonder vluchtreactie; voedt paniekcyclus)}
\end{enumerate}
\end{contextbox}
...
\checkitemBFS{5}{Bewuste ontspanningsoefening of ademhaling bij spanning (min)}
\checkitemBFS{6}{Sociale activiteit bewust opgezocht vandaag (ja/nee)}
\checkitemBFS{7}{Veiligheidsgedraging bewust nagelaten bij angstsituatie (ja/nee)}
\checkitemBFS{8}{Werkstructuur of dagindeling bewust gevolgd (ja/nee)}
...
\checkitemBFS{13}{Interoceptieve oefening bewust uitgevoerd (min)}
...
\checkitemBFS{19}{Bewust sociaal contact of gezelschap opgezocht vandaag (ja/nee)}
