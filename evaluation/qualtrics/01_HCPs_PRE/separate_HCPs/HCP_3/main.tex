...
\checkitemBFS{2}{Minuten gewacht voor uitvoeren van een compulsie (min)}
\checkitemBFS{3}{Slaapduur afgelopen nacht (uren)}
\checkitemBFS{4}{Compulsieve handeling volledig uitgesteld (ja/nee)}
\checkitemBFS{5}{Spierspanning in de schouders (0--10)}
\checkitemBFS{6}{Cafeine-inname na de middag (aantal)}
\checkitemBFS{7}{Vermeden situatie betreden zonder compulsie (ja/nee)}
\checkitemBFS{8}{Studie-uren vandaag (uren)}
\checkitemBFS{9}{Somatische angstsensaties (0--10)}
\checkitemBFS{10}{Duur verblijf in obsessie-activerende situatie zonder vermijden (min)}
\checkitemBFS{11}{Maaltijdlust vandaag (0--10)}
\checkitemBFS{12}{Slaapritme consistent gevolgd (ja/nee)}
\checkitemBFS{13}{Onzekerheid getolereerd zonder controlehandeling (min)}
\checkitemBFS{14}{Geruststelling gevraagd (aantal)}
\checkitemBFS{15}{Alcoholinname in de avond (aantal)}
\checkitemBFS{16}{Onzekerheidstolerantieoefening bewust uitgevoerd (ja/nee)}
\checkitemBFS{17}{Concentratie tijdens studeren (0--10)}
\checkitemBFS{18}{Contact met vrienden vandaag (ja/nee)}
\checkitemBFS{19}{Aantal sociale afspraken vandaag (aantal)}
\checkitemBFS{20}{Lichamelijke activiteit vandaag (min)}
\vspace{0.4em}
...
\checkitemBFS{2}{Professionele situatie bewust opgezocht (ja/nee)}
\checkitemBFS{3}{Aantal koffies voor een afspraak (aantal)}
\checkitemBFS{4}{Lichamelijke spanning voor het werk (0--10)}
\checkitemBFS{5}{Spreektijd in een vergadering of meeting (min)}
\checkitemBFS{6}{Positieve feedback ontvangen (ja/nee)}
\checkitemBFS{7}{Naverwerking van professionele prestatie in avond (min)}
\checkitemBFS{8}{Werkuren vandaag (uren)}
\checkitemBFS{9}{Middagpauze genomen (ja/nee)}
\checkitemBFS{10}{Mentale replay van een situatie voor het slapengaan (ja/nee)}
\checkitemBFS{11}{Schermtijd na 21.00 uur (min)}
\checkitemBFS{12}{Zelfevaluatie vergeleken met externe feedback (ja/nee)}
\checkitemBFS{13}{Gemiste professionele kans genoteerd (ja/nee)}
\checkitemBFS{14}{Eetlust voor de lunch (0--10)}
\checkitemBFS{15}{Aerobe beweging vandaag (min)}
\checkitemBFS{16}{Vermijdingsepisode in logboek bijgehouden (ja/nee)}
\checkitemBFS{17}{Irritatie naar collega's (0--10)}
\checkitemBFS{18}{Ochtendmoeheid (0--10)}
\checkitemBFS{19}{Aantal sociale berichten verstuurd (aantal)}
