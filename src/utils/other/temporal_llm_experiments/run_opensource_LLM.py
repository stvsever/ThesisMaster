...
# Example:
# python /Users/stijnvanseveren/PythonProjects/MASTERPROEF/utils/other/temporal_llm_experiments/run_opensource_LLM.py --interactive --model_id Qwen/Qwen2.5-1.5B-Instruct
