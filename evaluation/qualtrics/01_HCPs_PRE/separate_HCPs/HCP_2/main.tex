...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=4.75pt, draw=PrimaryBlue!80, opacity=0.90] (p1.east) -- (cr1.west);
  \draw[line width=4.12pt, draw=PrimaryBlue!80, opacity=0.90] (p1.east) -- (cr2.west);
  \draw[line width=5.0pt, draw=PrimaryBlue!80, opacity=0.90] (p2.east) -- (cr1.west);
  \draw[line width=1.25pt, draw=PrimaryBlue!80, opacity=0.90] (p2.east) -- (cr3.west);
  \draw[line width=4.5pt, draw=PrimaryBlue!80, opacity=0.90] (p3.east) -- (cr3.west);
  \draw[line width=1.63pt, draw=PrimaryBlue!80, opacity=0.90] (p4.east) -- (cr2.west);
  \draw[line width=1.0pt, draw=PrimaryBlue!80, opacity=0.90] (p4.east) -- (cr4.west);
  \draw[line width=2.0pt, draw=PrimaryBlue!80, opacity=0.90] (p5.east) -- (cr1.west);
  \draw[line width=1.63pt, draw=PrimaryBlue!80, opacity=0.90] (p5.east) -- (cr4.west);
  % Legend
  \draw[line width=0.3pt, draw=black!25] (-0.2, -2.85) -- (9.2, -2.85);
  \draw[line width=2.2pt, draw=StrongRed!85, opacity=0.90] (0.0, -3.25) -- (1.1, -3.25);
  \node[font=\fontsize{5.5}{7}\selectfont, anchor=west, text=black!70] at (1.2, -3.25) {Rood = risicofactor (positief verband: predictor vergroot criterium)};
  \draw[line width=2.2pt, draw=PrimaryBlue!80, opacity=0.90] (5.1, -3.25) -- (6.2, -3.25);
  \node[font=\fontsize{5.5}{7}\selectfont, anchor=west, text=black!70] at (6.3, -3.25) {Blauw = beschermend (negatief verband: predictor verkleint criterium)};
  \node[font=\fontsize{5.0}{6.5}\selectfont, anchor=west, text=black!50] at (0.0, -3.72) {Lijndikte proportioneel aan $|w|$ (binnen netwerk genormaliseerd; bereik 1--5 pt).};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=4.5pt, draw=PrimaryBlue!80, opacity=0.90] (p1.east) -- (cr1.west);
  \draw[line width=5.0pt, draw=PrimaryBlue!80, opacity=0.90] (p1.east) -- (cr4.west);
  \draw[line width=4.75pt, draw=PrimaryBlue!80, opacity=0.90] (p2.east) -- (cr2.west);
  \draw[line width=1.0pt, draw=PrimaryBlue!80, opacity=0.90] (p3.east) -- (cr1.west);
  \draw[line width=1.63pt, draw=PrimaryBlue!80, opacity=0.90] (p3.east) -- (cr3.west);
  \draw[line width=4.12pt, draw=PrimaryBlue!80, opacity=0.90] (p4.east) -- (cr3.west);
  \draw[line width=4.75pt, draw=PrimaryBlue!80, opacity=0.90] (p5.east) -- (cr4.west);
  % Legend
  \draw[line width=0.3pt, draw=black!25] (-0.2, -2.85) -- (9.2, -2.85);
  \draw[line width=2.2pt, draw=StrongRed!85, opacity=0.90] (0.0, -3.25) -- (1.1, -3.25);
  \node[font=\fontsize{5.5}{7}\selectfont, anchor=west, text=black!70] at (1.2, -3.25) {Rood = risicofactor (positief verband: predictor vergroot criterium)};
