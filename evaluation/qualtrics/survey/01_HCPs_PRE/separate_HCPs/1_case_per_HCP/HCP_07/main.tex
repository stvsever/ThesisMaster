...
\hypersetup{
  ...
  linkcolor=black,
  urlcolor=black,
  pdftitle={PHOENIX evaluatiestudie - HCP-PRE-07 (C07)},
...
\fancyhead[R]{\small\color{SlateMid}\textbf{HCP-PRE-07}\quad C07}
...
\centering
{\large\bfseries\color{DarkBlue}Deelnemerscode: \texttt{HCP-PRE-07}}\\[0.5em]
...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=0.4pt, draw=StrongRed!85, opacity=0.90] (bo4.east) -- (s4.west);
  \draw[line width=0.4pt,  draw=StrongRed!85, opacity=0.90] (bo3.east) -- (s1.west);
  % Legend
...
\checkitemBFS{1}{Cafeine-inname na 15.00 uur beperkt (ja/nee)}
...
\checkitemBFS{17}{Pijnklachten of lichamelijke ongemakken bijgehouden in een dagboek (ja/nee)}
...
\checkitemBFS{20}{Bewuste ademhaling of ontspanningsoefening in de ochtend uitgevoerd (min)}
\vspace{0.4em}
...
\begin{center}
\texttt{stijn.vanseveren@ugent.be}\quad met onderwerp:\quad \texttt{PHOENIX-PRE-HCP-PRE-07}
\end{center}
