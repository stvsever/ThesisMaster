...
\hypersetup{
  ...
  linkcolor=black,
  urlcolor=black,
  pdftitle={PHOENIX evaluatiestudie - HCP-PRE-02 (C02)},
...
\fancyhead[R]{\small\color{SlateMid}\textbf{HCP-PRE-02}\quad C02}
...
\subsection*{Casus 1: 34-jarige administratief medewerker in de zorg}

\begin{complaintbox}[title={Casus 1: 34-jarige administratief medewerker in de zorg; duur: 3 maanden}]
...
\newpage
\subsection*{Casus 1: 34-jarige administratief medewerker in de zorg -- Deel 2}
...
\newpage
\subsection*{Casus 1: 34-jarige administratief medewerker in de zorg -- Deel 3}

\begin{complaintbox}[title={Casus 1: 34-jarige administratief medewerker in de zorg}]
...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=0.4pt,  draw=PrimaryBlue!80, opacity=0.90] (p2.east) -- (cr1.west);
  \draw[line width=0.4pt,  draw=StrongRed!85, opacity=0.90] (p5.east) -- (cr4.west);
...
\newpage
\subsection*{Casus 1: 34-jarige administratief medewerker in de zorg -- Deel 4}
...
\newpage
\subsection*{Casus 1: 34-jarige administratief medewerker in de zorg -- Deel 5}
