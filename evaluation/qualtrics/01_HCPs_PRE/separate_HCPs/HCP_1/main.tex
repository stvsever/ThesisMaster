...
\checkitemBFS{2}{Smartphone-/tabletgebruik in bed na 22.00 uur (min)}
\checkitemBFS{3}{Slaapduur afgelopen nacht (uren)}
\checkitemBFS{4}{Nek- en schouderspanning in de avond (0--10)}
\checkitemBFS{5}{Scherm als laatste activiteit voor het slapengaan (ja/nee)}
\checkitemBFS{6}{Werkuren vandaag (uren)}
\checkitemBFS{7}{Ochtendlichtblootstelling (min)}
\checkitemBFS{8}{Onafgewerkte taken opgeschreven voor het slapengaan (ja/nee)}
\checkitemBFS{9}{Alcoholinname in de avond (aantal)}
\checkitemBFS{10}{Piekeren over sociale contacten (0--10)}
\checkitemBFS{11}{Kort dagboekmoment voor het slapengaan (min)}
\checkitemBFS{12}{Waterinname vandaag (glazen)}
\checkitemBFS{13}{Concentratie overdag (0--10)}
\checkitemBFS{14}{Stappentelling overdag (stappen)}
\checkitemBFS{15}{Sociaal contact vandaag geinitieerd (ja/nee)}
\checkitemBFS{16}{Middagdutje genomen (ja/nee)}
\checkitemBFS{17}{Duur matige tot intensieve sportactiviteit vandaag (min)}
\checkitemBFS{18}{Spierspanning lage rug (0--10)}
\checkitemBFS{19}{Inslaapduur gisteren (min)}
\checkitemBFS{20}{Eetlust bij avondmaal (0--10)}
\vspace{0.4em}
...
\checkitemBFS{1}{Exposurestap uit hierarchie uitgevoerd (ja/nee)}
\checkitemBFS{2}{Cafeine-inname voor 12.00 uur (aantal)}
\checkitemBFS{3}{Rusthartslag bij ontwaken (slagen/min)}
\checkitemBFS{4}{Duur verblijf in vermeden situatie (min)}
\checkitemBFS{5}{Spierspanning in schouders (0--10)}
\checkitemBFS{6}{Sociale contacten vandaag (aantal)}
\checkitemBFS{7}{Concrete veiligheidsactie bewust nagelaten (ja/nee)}
\checkitemBFS{8}{Stress op het werk (0--10)}
\checkitemBFS{9}{Inslaaptijd afgelopen nacht (min)}
\checkitemBFS{10}{Aantal vermijdingshandelingen ingeperkt vandaag (aantal)}
\checkitemBFS{11}{Waterinname vandaag (glazen)}
\checkitemBFS{12}{Plezier in vrijetijdsactiviteit (0--10)}
\checkitemBFS{13}{Lichamelijke sensaties bewust geobserveerd zonder te handelen (min)}
\checkitemBFS{14}{Aantal dutjes overdag (min)}
\checkitemBFS{15}{Eetlust vandaag (0--10)}
\checkitemBFS{16}{Stemmingsval in de namiddag (0--10)}
\checkitemBFS{17}{Aandacht bewust van lichaamssensaties afgeleid (ja/nee)}
\checkitemBFS{18}{Stapelteller vandaag (aantal)}
\checkitemBFS{19}{Concentratie tijdens administratie (0--10)}
\checkitemBFS{20}{Alcoholinname vanavond (aantal)}
\vspace{0.4em}
\noindent\textbf{Totaal geselecteerd:}\hspace{0.5em}\rule{1.2cm}{0.25pt}\hspace{0.2em}/ 6
\end{responsebox}
