...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=4.47pt, draw=PrimaryBlue!80, opacity=0.90] (p1.east) -- (cr2.west);
  \draw[line width=1.4pt, draw=PrimaryBlue!80, opacity=0.90] (p2.east) -- (cr2.west);
  ...
  \draw[line width=2.33pt, draw=StrongRed!85, opacity=0.90] (p5.east) -- (cr4.west);
...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=3.79pt, draw=PrimaryBlue!80, opacity=0.90] (p2.east) -- (cr2.west);
  \draw[line width=1.36pt, draw=PrimaryBlue!80, opacity=0.90] (p2.east) -- (cr1.west);
  \draw[line width=4.15pt, draw=PrimaryBlue!80, opacity=0.90] (p3.east) -- (cr2.west);
  \draw[line width=3.42pt, draw=PrimaryBlue!80, opacity=0.90] (p3.east) -- (cr1.west);
  \draw[line width=4.39pt, draw=StrongRed!85, opacity=0.90] (p4.east) -- (cr3.west);
