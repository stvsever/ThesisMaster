...
\hypersetup{
  ...
  linkcolor=black,
  urlcolor=black,
  pdftitle={PHOENIX evaluatiestudie - HCP-PRE-10 (C10)},
...
\fancyhead[R]{\small\color{SlateMid}\textbf{HCP-PRE-10}\quad C10}
...
\centering
{\large\bfseries\color{DarkBlue}Deelnemerscode: \texttt{HCP-PRE-10}}\\[0.5em]
...
\subsection*{Casus 1: 52-jarige operationeel directeur}

\begin{complaintbox}[title={Casus 1: 52-jarige operationeel directeur; duur: ongeveer 9 maanden}]
...
\newpage
\subsection*{Casus 1: 52-jarige operationeel directeur -- Deel 2}
...
\newpage
\subsection*{Casus 1: 52-jarige operationeel directeur -- Deel 3}

\begin{complaintbox}[title={Casus 1: 52-jarige operationeel directeur}]
...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=0.4pt, draw=StrongRed!85, opacity=0.90] (bo4.east) -- (s1.west);
...
\newpage
\subsection*{Casus 1: 52-jarige operationeel directeur -- Deel 4}
...
\checkitemBFS{8}{Sigaretten of tabak gerookt vandaag (aantal)}
...
\checkitemBFS{11}{Vast slaap- en waktijdstip aangehouden vandaag (ja/nee)}
...
\checkitemBFS{14}{Lichaamsbeweging of sport vandaag (min)}
\checkitemBFS{15}{Lichttherapielamp of wekker op licht gebruikt in de ochtend (ja/nee)}
\checkitemBFS{16}{Duur bewuste stressverlichtende activiteit overdag (min)}
\checkitemBFS{17}{Professioneel consult of therapeutische sessie bijgewoond vandaag (ja/nee)}
\checkitemBFS{18}{Gesprek met vertrouwenspersoon of steunfiguur gevoerd vandaag (ja/nee)}
\checkitemBFS{19}{Bewust dankbaarheidsoefening of positieve reflectie uitgevoerd vandaag (ja/nee)}
...
\newpage
\subsection*{Casus 1: 52-jarige operationeel directeur -- Deel 5}
...
\begin{center}
\texttt{stijn.vanseveren@ugent.be}\quad met onderwerp:\quad \texttt{PHOENIX-PRE-HCP-PRE-10}
\end{center}
