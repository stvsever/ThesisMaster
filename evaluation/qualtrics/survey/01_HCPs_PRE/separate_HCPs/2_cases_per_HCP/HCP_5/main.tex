...
beschrijven \emph{wat er mis gaat} (bijv.\ snelle stemmingsschommelingen, doorslaapinsomnie,
chronische werkstress). Symptomen zijn geen gedragingen of interventies.
...
netwerk -- ze beschrijven \emph{wat veranderbaar is} (bijv.\ emotieregulatievaardigheid,
impulsuitstel, werkontkoppeling voor slaap). Een behandelingsoptie is \emph{nooit een symptoom zelf},
...
\item \textbf{Symptoom:} snelle stemmingsschommelingen, afwijzingsreactiviteit, impulsief gedrag, doorslaapinsomnie.
\item \textbf{Behandelingsoptie:} emotieregulatietechniek (ja/nee), impulsuitstel (min wachttijd),
werkontkoppelingsritueel (min), alcoholeenheden 's avonds (aantal).
\end{itemize}
\end{instrbox}
...
emotieregulatietechniek, impulsuitstel, afwijzingsherwaardering, werkontkoppeling,
avondlijk alcoholgebruik, stressregulatie overdag, aerobe beweging.

\textbf{Let op:} variabelen als ``stemmingsschommelingen'', ``afwijzingsreactiviteit'' of
``doorslaapinsomnie'' zijn klachtdimensies (symptomen) -- geen behandelingsopties. Kies
variabelen die de persoon actief kan uitvoeren of aanpassen.
...
\begin{itemize}[topsep=2pt,itemsep=1pt]
\item \textbf{S-1} Snelle stemmingsschommelingen
\item \textbf{S-2} Afwijzingsreactiviteit
\item \textbf{S-3} Impulsief gedrag
\item \textbf{S-4} Relationele instabiliteit
\end{itemize}
\end{contextbox}
...
\small 52-jarige operationeel directeur; duur: ongeveer 9 maanden. Chronische werkstress, doorslaapinsomnie, somatische stressklachten en alcohol als copingstrategie.
\end{complaintbox}

\begin{contextbox}
\small\textbf{Gestandaardiseerde symptomen uit Deel 1:}
\begin{itemize}[topsep=2pt,itemsep=1pt]
\item \textbf{S-1} Chronische werkstress
\item \textbf{S-2} Doorslaapinsomnie
\item \textbf{S-3} Somatische stressklachten
\item \textbf{S-4} Alcohol als copingstrategie
\end{itemize}
\end{contextbox}
...
(meer van BO $\rightarrow$ meer van S; bijv.\ meer avondlijk alcoholgebruik $\rightarrow$ meer slaapfragmentatie).
\item \textbf{Rode rand:} behandelingsoptie heeft een negatief verband met het symptoom
(meer van BO $\rightarrow$ minder van S; bijv.\ meer impulsuitstel $\rightarrow$ minder impulsief gedrag).
...
\begin{center}
\begin{tikzpicture}[node distance=0pt]
  \node[prnode] (bo1) at (0, 2.2) {BO-1\\Emotieregulatievaardigheid};
  \node[prnode] (bo2) at (0, 1.1) {BO-2\\Afwijzingsherwaardering};
  \node[prnode] (bo3) at (0, 0.0) {BO-3\\Impulsuitstel};
  \node[prnode] (bo4) at (0, -1.1) {BO-4\\Interpersoonlijke communicatie};
  \node[prnode] (bo5) at (0, -2.2) {BO-5\\Gedifferentieerde stemmingsmonitoring};
  \node[crnode] (s1) at (9, 1.65) {S-1\\Snelle stemmingsschommelingen};
  \node[crnode] (s2) at (9, 0.55) {S-2\\Afwijzingsreactiviteit};
  \node[crnode] (s3) at (9, -0.55) {S-3\\Impulsief gedrag};
  \node[crnode] (s4) at (9, -1.65) {S-4\\Relationele instabiliteit};
  \draw[line width=5.0pt, draw=StrongRed!85, opacity=0.90] (bo2.east) -- (s2.west);
  \draw[line width=4.44pt, draw=StrongRed!85, opacity=0.90] (bo3.east) -- (s3.west);
  \draw[line width=4.23pt, draw=StrongRed!85, opacity=0.90] (bo1.east) -- (s1.west);
  \draw[line width=3.81pt, draw=StrongRed!85, opacity=0.90] (bo1.east) -- (s2.west);
  \draw[line width=3.32pt, draw=StrongRed!85, opacity=0.90] (bo4.east) -- (s4.west);
  \draw[line width=2.89pt, draw=StrongRed!85, opacity=0.90] (bo2.east) -- (s4.west);
  \draw[line width=1.56pt, draw=StrongRed!85, opacity=0.90] (bo4.east) -- (s2.west);
  \draw[line width=1.42pt, draw=StrongRed!85, opacity=0.90] (bo5.east) -- (s4.west);
  \draw[line width=1.0pt, draw=StrongRed!85, opacity=0.90] (bo5.east) -- (s1.west);
  % Legend
...
\textbf{BO-1: Emotieregulatievaardigheid},\quad
\textbf{BO-2: Afwijzingsherwaardering},\quad
\textbf{BO-3: Impulsuitstel},\quad
\textbf{BO-4: Interpersoonlijke communicatie},\quad
\textbf{BO-5: Gedifferentieerde stemmingsmonitoring}
...
\small Chronische werkstress, doorslaapinsomnie, somatische stressklachten en alcohol als copingstrategie. Duur: ongeveer 9 maanden.
\end{complaintbox}
...
\begin{center}
\begin{tikzpicture}[node distance=0pt]
  \node[prnode] (bo1) at (0, 2.2) {BO-1\\Werkontkoppeling voor slaap};
  \node[prnode] (bo2) at (0, 1.1) {BO-2\\Avondlijk alcoholgebruik};
  \node[prnode] (bo3) at (0, 0.0) {BO-3\\Stressregulatie overdag};
  \node[prnode] (bo4) at (0, -1.1) {BO-4\\Aerobe beweging};
  \node[prnode] (bo5) at (0, -2.2) {BO-5\\Nachtelijke cognitieve arousal};
  \node[crnode] (s1) at (9, 1.65) {S-1\\Chronische werkstress};
  \node[crnode] (s2) at (9, 0.55) {S-2\\Doorslaapinsomnie};
  \node[crnode] (s3) at (9, -0.55) {S-3\\Somatische stressklachten};
  \node[crnode] (s4) at (9, -1.65) {S-4\\Alcohol als copingstrategie};
  \draw[line width=4.62pt, draw=StrongRed!85, opacity=0.90] (bo1.east) -- (s2.west);
  \draw[line width=4.08pt, draw=StrongRed!85, opacity=0.90] (bo1.east) -- (s1.west);
  \draw[line width=5.0pt, draw=PrimaryBlue!80, opacity=0.90] (bo2.east) -- (s4.west);
  \draw[line width=3.62pt, draw=PrimaryBlue!80, opacity=0.90] (bo2.east) -- (s2.west);
  \draw[line width=3.85pt, draw=StrongRed!85, opacity=0.90] (bo3.east) -- (s3.west);
  \draw[line width=2.85pt, draw=StrongRed!85, opacity=0.90] (bo3.east) -- (s1.west);
  \draw[line width=2.31pt, draw=StrongRed!85, opacity=0.90] (bo4.east) -- (s3.west);
  \draw[line width=1.0pt, draw=StrongRed!85, opacity=0.90] (bo4.east) -- (s1.west);
  \draw[line width=4.38pt, draw=PrimaryBlue!80, opacity=0.90] (bo5.east) -- (s2.west);
  % Legend
  \draw[line width=0.3pt, draw=black!25] (-0.3, -2.82) -- (9.3, -2.82);
  \draw[line width=2.2pt, draw=PrimaryBlue!80, opacity=0.90] (0.1, -3.18) -- (1.2, -3.18);
  \node[font=\fontsize{5.5}{7}\selectfont, anchor=west, text=black!70] at (1.35, -3.18) {\textbf{Blauw} = positief verband \enspace (BO \emph{vergroot} S)};
...
\noindent\textbf{Beschikbare behandelingsopties:}\enspace
\textbf{BO-1: Werkontkoppeling voor slaap},\quad
\textbf{BO-2: Avondlijk alcoholgebruik},\quad
\textbf{BO-3: Stressregulatie overdag},\quad
\textbf{BO-4: Aerobe beweging},\quad
\textbf{BO-5: Nachtelijke cognitieve arousal}
...
\begin{enumerate}[topsep=2pt,itemsep=1pt,label=\arabic*.]
\item \textbf{Emotieregulatietechnieken}
\item \textbf{Impulsuitstel}
\item \textbf{Cognitieve herwaardering bij interpersoonlijke spanning}
\end{enumerate}
\end{contextbox}
...
\item \textbf{Alcoholgebruik verminderen}
\item \textbf{Actieve stressregulatie}
\end{enumerate}
\end{contextbox}
