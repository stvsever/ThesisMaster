...
\hypersetup{
  ...
  linkcolor=black,
  urlcolor=black,
  pdftitle={PHOENIX evaluatiestudie - HCP-PRE-01 (C01)},
...
\fancyhead[R]{\small\color{SlateMid}\textbf{HCP-PRE-01}\quad C01}
...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=1.8pt, draw=PrimaryBlue!80, opacity=0.90] (p1.east) -- (cr1.west);
  ...
  \draw[line width=0.4pt,  draw=StrongRed!85, opacity=0.90] (p5.east) -- (cr1.west);
...
\checkitemBFS{16}{Financiele zorgen of administratieve taken aangepakt vandaag (ja/nee)}
\checkitemBFS{17}{Bewust dankbaarheidsoefening of positieve reflectie uitgevoerd vandaag (ja/nee)}
\checkitemBFS{18}{Werkpauzes op vaste tijden genomen vandaag (ja/nee)}
\checkitemBFS{19}{Pijnklachten of lichamelijke ongemakken bijgehouden in een dagboek (ja/nee)}
\checkitemBFS{20}{Betekenisvolle of waardegerichte activiteit ondernomen vandaag (ja/nee)}
\vspace{0.4em}
