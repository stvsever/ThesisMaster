...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=4.47pt, draw=PrimaryBlue!80, opacity=0.90] (p1.east) -- (cr4.west);
  \draw[line width=4.73pt, draw=PrimaryBlue!80, opacity=0.90] (p2.east) -- (cr3.west);
  \draw[line width=4.07pt, draw=PrimaryBlue!80, opacity=0.90] (p3.east) -- (cr1.west);
  \draw[line width=4.73pt, draw=PrimaryBlue!80, opacity=0.90] (p3.east) -- (cr2.west);
  \draw[line width=1.0pt, draw=PrimaryBlue!80, opacity=0.90] (p4.east) -- (cr1.west);
  \draw[line width=4.47pt, draw=StrongRed!85, opacity=0.90] (p5.east) -- (cr2.west);
  \draw[line width=1.4pt, draw=StrongRed!85, opacity=0.90] (p5.east) -- (cr4.west);
  % Legend
...
\begin{tikzpicture}[node distance=0pt]
  ...
  \draw[line width=4.7pt, draw=PrimaryBlue!80, opacity=0.90] (p1.east) -- (cr1.west);
  \draw[line width=5.0pt, draw=PrimaryBlue!80, opacity=0.90] (p1.east) -- (cr4.west);
  \draw[line width=4.41pt, draw=PrimaryBlue!80, opacity=0.90] (p2.east) -- (cr2.west);
  \draw[line width=1.44pt, draw=StrongRed!85, opacity=0.90] (p3.east) -- (cr1.west);
  \draw[line width=1.0pt, draw=StrongRed!85, opacity=0.90] (p3.east) -- (cr2.west);
  \draw[line width=5.0pt, draw=StrongRed!85, opacity=0.90] (p4.east) -- (cr3.west);
  \draw[line width=3.52pt, draw=PrimaryBlue!80, opacity=0.90] (p5.east) -- (cr4.west);
  % Legend
  \draw[line width=0.3pt, draw=black!25] (-0.2, -2.85) -- (9.2, -2.85);
  \draw[line width=2.2pt, draw=StrongRed!85, opacity=0.90] (0.0, -3.25) -- (1.1, -3.25);
  \node[font=\fontsize{5.5}{7}\selectfont, anchor=west, text=black!70] at (1.2, -3.25) {Rood = risicofactor (positief verband: predictor vergroot criterium)};
