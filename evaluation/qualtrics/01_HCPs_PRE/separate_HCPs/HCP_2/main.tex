...
\checkitemBFS{2}{Werkmail na 18.00 uur gecheckt (ja/nee)}
\checkitemBFS{3}{Piekeren over leerlingen of klassen (0--10)}
\checkitemBFS{4}{Werkgerelateerde gedachten bewust gestopt na werktijd (ja/nee)}
\checkitemBFS{5}{Cafeine-inname na 15.00 uur (aantal)}
\checkitemBFS{6}{Eetlust bij avondmaal (0--10)}
\checkitemBFS{7}{Ochtendspanning bij ontwaken (0--10)}
\checkitemBFS{8}{Ontspanningsactiviteit buiten werk uitgevoerd (min)}
\checkitemBFS{9}{Slaapkwaliteit bij ontwaken (0--10)}
\checkitemBFS{10}{Administratieve achterstand (0--10)}
\checkitemBFS{11}{Herstelactiviteit in agenda gepland (ja/nee)}
\checkitemBFS{12}{Lichamelijke pijnklachten na het werk (0--10)}
\checkitemBFS{13}{Reistijd woon-werk (min)}
\checkitemBFS{14}{Moment van positieve lesprestatie genoteerd (ja/nee)}
\checkitemBFS{15}{Schermtijd in de late avond (min)}
\checkitemBFS{16}{Aantal nieuwschecks in de avond (aantal)}
\checkitemBFS{17}{Professionele vaardigheid succesvol ingezet (0--10)}
\checkitemBFS{18}{Aantal maaltijden overgeslagen (aantal)}
\checkitemBFS{19}{Aantal lesuren vandaag (uren)}
\checkitemBFS{20}{Irritatie tegenover collega's (0--10)}
\vspace{0.4em}
...
\checkitemBFS{6}{Duur van een betekenisvolle bezigheid vandaag (min)}
\checkitemBFS{7}{Maaltijdlust vandaag (0--10)}
\checkitemBFS{8}{Opstaan op vast tijdstip (ja/nee)}
\checkitemBFS{9}{Lichamelijke onrust in de avond (0--10)}
\checkitemBFS{10}{Schermtijd na 21.00 uur (min)}
\checkitemBFS{11}{Afwijking van gewone slaap- of wektijd (min)}
\checkitemBFS{12}{Vermijden van herinneringsvoorwerpen (ja/nee)}
\checkitemBFS{13}{Alcoholinname in de avond (aantal)}
\checkitemBFS{14}{Zelfkritische gedachte bewust omgevormd (ja/nee)}
\checkitemBFS{15}{Huishoudelijke taken voltooid (aantal)}
\checkitemBFS{16}{Pijnintensiteit in gewrichten (0--10)}
\checkitemBFS{17}{Zelfcompassie-oefening toegepast (min)}
\checkitemBFS{18}{Ochtendenergie bij opstaan (0--10)}
\checkitemBFS{19}{Middagdutje genomen (ja/nee)}
\checkitemBFS{20}{Werk- of zorgtaken voor anderen (min)}
\vspace{0.4em}
\noindent\textbf{Totaal geselecteerd:}\hspace{0.5em}\rule{1.2cm}{0.25pt}\hspace{0.2em}/ 6
\end{responsebox}
