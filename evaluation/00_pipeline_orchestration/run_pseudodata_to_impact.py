...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ...
    pseudodata_default = evaluation_root_default / "01_pseudoprofile(s)/time_series_data/pseudodata"
    runs_default = evaluation_root_default / "05_integrated_pipeline_runs"
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Optional root containing Step-02 model runs (overrides default evaluation path).",
    )
    parser.add_argument(
        "--free-text-root",
        type=str,
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    default_initial_model_runs_root = evaluation_root / "03_construction_initial_observation_model/constructed_PC_models/runs"
    default_free_text_root = evaluation_root / "01_pseudoprofile(s)/free_text"
    ...
    report_script = evaluation_root / "07_research_communication/generate_pipeline_research_report.py"
